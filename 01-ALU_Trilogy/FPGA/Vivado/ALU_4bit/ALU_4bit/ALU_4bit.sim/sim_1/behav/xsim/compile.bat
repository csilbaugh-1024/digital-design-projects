...
REM
REM Generated by Vivado on Fri Jun 26 10:17:44 -0400 2026
...
echo "xvhdl --incr --relax -prj mux_8x1_4bit_tb_vhdl.prj"
call xvhdl  --incr --relax -prj mux_8x1_4bit_tb_vhdl.prj -log xvhdl.log
