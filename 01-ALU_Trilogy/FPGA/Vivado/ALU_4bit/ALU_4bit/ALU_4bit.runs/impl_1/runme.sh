...
HD_PWD='C:/Engineering/Digital-Design-Projects/01-ALU_Trilogy/FPGA/Vivado/ALU_4bit/ALU_4bit/ALU_4bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_4bit.tcl -notrace
