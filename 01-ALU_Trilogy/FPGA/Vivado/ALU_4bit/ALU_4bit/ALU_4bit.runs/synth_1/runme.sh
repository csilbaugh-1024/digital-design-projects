...
HD_PWD='C:/Engineering/Digital-Design-Projects/01-ALU_Trilogy/FPGA/Vivado/ALU_4bit/ALU_4bit/ALU_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_4bit.tcl
