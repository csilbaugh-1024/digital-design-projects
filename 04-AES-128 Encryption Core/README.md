...
The leftmost 4 columns of the 44-column expanded key matrix contain the original, first key, and the next 10 round keys generated by KeyExpansion are all derived from this first key using a specific formula.
